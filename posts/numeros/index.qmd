...
Consideremos un conjunto con tres elementos $A=\{a, b, c\}$ y un conjunto con cinco elementos $B=\{x,y,z,w,v\}$. La asignaci\'on $a \mapsto z$, $b \mapsto v$ y $c \mapsto z$ es un ejemplo de funci\'on $f$ representada gr\'aficamente como:
