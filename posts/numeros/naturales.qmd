...
<div style="font-family: sans-serif; max-width: 520px; margin: 10px auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px; background: #fff; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
  ...
  <!-- Lienzo donde se dibuja el gráfico y los óvalos de los conjuntos -->
  <svg id="lienzo-funcion" width="100%" height="340" viewBox="0 0 400 340" style="background: #f8fafc; border-radius: 6px; border: 1px solid #edf2f7;"></svg>
...
function actualizarEstado() {
  ...
  // Verificación de totalidad y sobreyectividad
