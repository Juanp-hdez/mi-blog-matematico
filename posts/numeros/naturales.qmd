...
<div style="font-family: system-ui, -apple-system, sans-serif; max-width: 650px; margin: 20px auto; padding: 25px; border: 1px solid #e2e8f0; border-radius: 12px; background: #ffffff; box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1);">
  ...
  <h3 style="text-align: center; color: #1e293b; margin-top: 0; margin-bottom: 8px;">Cajas de Asignación Multielemento</h3>
  <p style="text-align: center; color: #64748b; font-size: 14px; margin-bottom: 20px;">
    Inserta letras (<b>x, y, z, w</b>) dentro de las cajas (<b>a, b, c</b>). Puedes agregar varias por caja o borrarlas para reiniciar.
  </p>

  <!-- Botón de vaciado global -->
  <div style="text-align: center; margin-bottom: 20px;">
    <button onclick="vaciarTodo()" style="padding: 6px 14px; background: #f1f5f9; border: 1px solid #cbd5e1; border-radius: 6px; color: #475569; font-weight: bold; cursor: pointer;">
      🗑️ Vaciar todas las cajas
    </button>
  </div>

  <!-- Grilla de las 3 Cajas -->
  <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 15px; margin-bottom: 25px;">
    
    <!-- Caja a -->
    <div style="border: 2px dashed #3b82f6; border-radius: 10px; background: #eff6ff; padding: 12px; text-align: center; display: flex; flex-direction: column; justify-content: space-between;">
      <div style="font-weight: 800; font-size: 18px; color: #1d4ed8; margin-bottom: 8px;">CAJA a</div>
      
      <!-- Contenedor visual de las letras agregadas -->
      <div id="box-a" style="min-height: 60px; padding: 6px; background: #ffffff; border: 1px solid #cbd5e1; border-radius: 6px; display: flex; flex-wrap: wrap; gap: 4px; align-items: center; justify-content: center; margin-bottom: 10px;">
        <span style="color: #94a3b8; font-size: 13px; font-style: italic;">(Vacía)</span>
      </div>

      <!-- Botones para agregar letras -->
      <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 4px; margin-bottom: 8px;">
        <button onclick="agregar('a', 'x')" style="padding: 4px; background: #3b82f6; color: white; border: none; border-radius: 4px; font-weight: bold; cursor: pointer;">+ x</button>
        <button onclick="agregar('a', 'y')" style="padding: 4px; background: #3b82f6; color: white; border: none; border-radius: 4px; font-weight: bold; cursor: pointer;">+ y</button>
        <button onclick="agregar('a', 'z')" style="padding: 4px; background: #3b82f6; color: white; border: none; border-radius: 4px; font-weight: bold; cursor: pointer;">+ z</button>
        <button onclick="agregar('a', 'w')" style="padding: 4px; background: #3b82f6; color: white; border: none; border-radius: 4px; font-weight: bold; cursor: pointer;">+ w</button>
      </div>
    ...
    <!-- Caja b -->
    <div style="border: 2px dashed #3b82f6; border-radius: 10px; background: #eff6ff; padding: 12px; text-align: center; display: flex; flex-direction: column; justify-content: space-between;">
      <div style="font-weight: 800; font-size: 18px; color: #1d4ed8; margin-bottom: 8px;">CAJA b</div>
      
      <div id="box-b" style="min-height: 60px; padding: 6px; background: #ffffff; border: 1px solid #cbd5e1; border-radius: 6px; display: flex; flex-wrap: wrap; gap: 4px; align-items: center; justify-content: center; margin-bottom: 10px;">
        <span style="color: #94a3b8; font-size: 13px; font-style: italic;">(Vacía)</span>
      </div>

      <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 4px; margin-bottom: 8px;">
        <button onclick="agregar('b', 'x')" style="padding: 4px; background: #3b82f6; color: white; border: none; border-radius: 4px; font-weight: bold; cursor: pointer;">+ x</button>
        <button onclick="agregar('b', 'y')" style="padding: 4px; background: #3b82f6; color: white; border: none; border-radius: 4px; font-weight: bold; cursor: pointer;">+ y</button>
        <button onclick="agregar('b', 'z')" style="padding: 4px; background: #3b82f6; color: white; border: none; border-radius: 4px; font-weight: bold; cursor: pointer;">+ z</button>
        <button onclick="agregar('b', 'w')" style="padding: 4px; background: #3b82f6; color: white; border: none; border-radius: 4px; font-weight: bold; cursor: pointer;">+ w</button>
      </div>
    ...
    <!-- Caja c -->
    <div style="border: 2px dashed #3b82f6; border-radius: 10px; background: #eff6ff; padding: 12px; text-align: center; display: flex; flex-direction: column; justify-content: space-between;">
      <div style="font-weight: 800; font-size: 18px; color: #1d4ed8; margin-bottom: 8px;">CAJA c</div>
      
      <div id="box-c" style="min-height: 60px; padding: 6px; background: #ffffff; border: 1px solid #cbd5e1; border-radius: 6px; display: flex; flex-wrap: wrap; gap: 4px; align-items: center; justify-content: center; margin-bottom: 10px;">
        <span style="color: #94a3b8; font-size: 13px; font-style: italic;">(Vacía)</span>
      </div>

      <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 4px; margin-bottom: 8px;">
        <button onclick="agregar('c', 'x')" style="padding: 4px; background: #3b82f6; color: white; border: none; border-radius: 4px; font-weight: bold; cursor: pointer;">+ x</button>
        <button onclick="agregar('c', 'y')" style="padding: 4px; background: #3b82f6; color: white; border: none; border-radius: 4px; font-weight: bold; cursor: pointer;">+ y</button>
        <button onclick="agregar('c', 'z')" style="padding: 4px; background: #3b82f6; color: white; border: none; border-radius: 4px; font-weight: bold; cursor: pointer;">+ z</button>
        <button onclick="agregar('c', 'w')" style="padding: 4px; background: #3b82f6; color: white; border: none; border-radius: 4px; font-weight: bold; cursor: pointer;">+ w</button>
      </div>
  ...
  <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 15px; text-align: center;">
    <div style="font-size: 12px; font-weight: bold; text-transform: uppercase; letter-spacing: 0.5px; color: #64748b; margin-bottom: 6px;">Representación en Notación de Conjuntos</div>
...
function render() {
  ...
  cajas.forEach(caja => {
    ...
    if (items.length === 0) {
      container.innerHTML = `<span style="color: #94a3b8; font-size: 13px; font-style: italic;">(Vacía)</span>`;
    } else {
      let html = '';
      items.forEach((item, idx) => {
        html += `
          <span onclick="eliminarElemento('${caja}', ${idx})" 
                title="Haz clic para borrar este elemento"
                style="background: #0284c7; color: white; padding: 2px 8px; border-radius: 12px; font-weight: bold; font-size: 14px; cursor: pointer; display: inline-flex; align-items: center; gap: 4px;">
