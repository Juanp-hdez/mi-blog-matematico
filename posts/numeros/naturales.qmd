  ...
  function iniciarModuloComposicionV2() {
    ...
    function renderDadas() {
      let html = `
        ...
        <text x="90" y="66" text-anchor="middle" font-weight="bold" font-size="15" fill="#2b6cb0">Conjunto A</text>

        <!-- Óvalo B -->
        <ellipse cx="310" cy="175" rx="48" ry="110" fill="#fffaf0" stroke="#dd6b20" stroke-width="2" stroke-dasharray="5 4"/>
        <text x="310" y="52" text-anchor="middle" font-weight="bold" font-size="15" fill="#c05621">Conjunto B</text>

        <!-- Óvalo C -->
        <ellipse cx="530" cy="175" rx="48" ry="95" fill="#f0fdf4" stroke="#16a34a" stroke-width="2" stroke-dasharray="5 4"/>
        <text x="530" y="66" text-anchor="middle" font-weight="bold" font-size="15" fill="#15803d">Conjunto C</text>
      `;
