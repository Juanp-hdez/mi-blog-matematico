...
```{=html}
<div style="font-family: system-ui, -apple-system, sans-serif; max-width: 580px; margin: 20px auto; padding: 25px; border: 1px solid #e2e8f0; border-radius: 12px; background: #ffffff; box-shadow: 0 10px 15px -3px rgba(0,0,0,0.08);">
  ...
  <p style="text-align: center; color: #64748b; font-size: 14px; margin-bottom: 15px;">
    Haz clic en un elemento de <b>A</b> y luego en uno de <b>B</b> para asignar su imagen.
  </p>
  ...
  <!-- Lienzo SVG -->
  <svg id="lienzo-sobreyectiva" width="100%" height="280" viewBox="0 0 400 280" style="background: #f8fafc; border-radius: 8px; border: 1px solid #edf2f7;"></svg>
  ...
  <div style="margin-top: 15px; display: flex; flex-direction: column; gap: 10px;">
    ...
    <div style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 8px; padding: 10px; text-align: center;">
      <span style="font-size: 12px; font-weight: bold; text-transform: uppercase; color: #64748b; display: block; margin-bottom: 4px;">Notación de la relación</span>
...
const yA = { a: 45, b: 110, c: 175, d: 240 };
const yB = { x: 45, y: 110, z: 175, w: 240 };
...
function dibujar() {
  ...
  let html = `
    ...
    <text x="100" y="20" text-anchor="middle" font-weight="bold" fill="#334155">Dominio (A)</text>
    <text x="300" y="20" text-anchor="middle" font-weight="bold" fill="#334155">Codominio (B)</text>
  `;
  ...
  elemA.forEach(nodo => {
    ...
    const fill = activo ? "#bfdbfe" : "#eff6ff";
  ...
  // Nodos de B
  elemB.forEach(nodo => {
    html += `<circle cx="300" cy="${yB[nodo]}" r="16" fill="#fef3c7" stroke="#d97706" stroke-width="2" style="cursor: pointer;" onclick="clicB('${nodo}')"/>`;
...
function evaluar() {
  ...
  // Comprobación de función bien definida (todos los elementos de A deben tener imagen)
  ...
  // Cálculo del Conjunto Imagen Im(f)
  ...
  if (imagenesAlcanzadas.size === 4) {
    ...
    panelEstado.innerHTML = "✅ ES SOBREYECTIVA: Todo elemento del codominio B recibe al menos una flecha (Im(f) = B).";
  } else {
    ...
    panelEstado.innerHTML = `❌ NO ES SOBREYECTIVA: Hay elementos en B sin preimagen: { ${faltantesB.join(', ')} }.`;
  }
}
