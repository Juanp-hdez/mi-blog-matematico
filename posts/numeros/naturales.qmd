...
se muestran las funciones $f$ y $g$. Al hacer la composición de $g$ con $f$ obtenemos la función $g \circ f$, que para determinar a donde envía cada elemento de $A$, basta seguir el camino de las flechas, es decir, $g \circ f$ envía $a \mapsto t$, $b \mapsto v$ y $c \mapsto u$.
