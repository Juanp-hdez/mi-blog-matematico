...
<div style="text-align: center; margin: 20px 0;">
  <svg width="480" height="380" viewBox="0 0 480 380" style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 8px;">
    <defs>
      <marker id="flecha-eje" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
    ...
    <!-- Ejes Cartesianos -->
    <line x1="60" y1="320" x2="440" y2="320" stroke="#2d3748" stroke-width="2" marker-end="url(#flecha-eje)"/>
    <line x1="60" y1="320" x2="60" y2="30" stroke="#2d3748" stroke-width="2" marker-end="url(#flecha-eje)"/>

    <!-- Nombres de Ejes -->
    <text x="450" y="325" font-weight="bold" font-family="serif" font-size="18" fill="#2d3748">A</text>
    <text x="55" y="20" font-weight="bold" font-family="serif" font-size="18" fill="#2d3748">B</text>

    <!-- Conjuntos A y B sobre los ejes -->
    ...
    <text x="340" y="125" font-family="serif" font-style="italic" font-size="16" fill="#2b6cb0">A × B</text>

    <!-- Líneas de Proyección -->
    <line x1="240" y1="180" x2="240" y2="315" stroke="#e53e3e" stroke-width="2" stroke-dasharray="5 3"/>
    <line x1="240" y1="180" x2="65" y2="180" stroke="#e53e3e" stroke-width="2" stroke-dasharray="5 3"/>
    ...
    <text x="240" y="345" font-family="serif" font-size="16" font-style="italic" font-weight="bold" fill="#e53e3e" text-anchor="middle">a</text>

    <circle cx="60" cy="180" r="5" fill="#e53e3e"/>
    <text x="42" y="185" font-family="serif" font-size="16" font-style="italic" font-weight="bold" fill="#e53e3e" text-anchor="end">b</text>
  </svg>
</div>
```
