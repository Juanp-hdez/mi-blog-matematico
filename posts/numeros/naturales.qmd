...
Como se puede ver en el siguiente gráfico, un elemento $a \in A$ está relacionado con todos los elementos de la linea roja vertical por medio de la función $\pi_{1}$, y un elemento $b \in B$ está relacionado con todos los elementos de la linea azul horizontal por medio de la función $\pi_{2}$.
...
<div style="text-align: center; margin: 20px 0;">
  <svg width="480" height="380" viewBox="0 0 480 380" style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 8px;">
    ...
    <!-- Indicadores de Proyección -->
    <path d="M 240 270 L 240 285" stroke="#e53e3e" stroke-width="2" marker-end="url(#flecha-proj)"/>
    <text x="250" y="285" font-family="serif" font-size="16" fill="#e53e3e" font-weight="bold">π₁</text>

    <text x="95" y="170" font-family="serif" font-size="16" fill="#2b6cb0" font-weight="bold">π₂</text>
