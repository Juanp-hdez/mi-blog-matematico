...
<div style="text-align: center; margin: 20px 0;">
  <svg width="480" height="380" viewBox="0 0 480 380" style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 8px;">
    ...
    <!-- LÍNEA VERTICAL EN ROJO PASANDO POR (a,b) -->
    <line x1="240" y1="40" x2="240" y2="320" stroke="#e53e3e" stroke-width="2" stroke-dasharray="5 3"/>

    <!-- LÍNEA HORIZONTAL EN AZUL PASANDO POR (a,b) -->
    <line x1="60" y1="180" x2="440" y2="180" stroke="#2b6cb0" stroke-width="2" stroke-dasharray="5 3"/>

    <!-- Indicadores de Proyección -->
    <path d="M 240 220 L 240 235" stroke="#e53e3e" stroke-width="2" marker-end="url(#flecha-proj)"/>
    <text x="250" y="235" font-family="serif" font-size="16" fill="#e53e3e" font-weight="bold">π₁</text>

    <path d="M 160 180 L 145 180" stroke="#2b6cb0" stroke-width="2"/>
    <text x="150" y="170" font-family="serif" font-size="16" fill="#2b6cb0" font-weight="bold">π₂</text>
