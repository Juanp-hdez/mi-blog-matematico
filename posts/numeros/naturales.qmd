  ...
  function iniciarModuloComposicionV2() {
    ...
    function renderCompuesta() {
      let html = `
        ...
        <text x="100" y="66" text-anchor="middle" font-weight="bold" font-size="15" fill="#2b6cb0">Conjunto A</text>

        <!-- Óvalo C -->
        <ellipse cx="320" cy="175" rx="55" ry="95" fill="#f0fdf4" stroke="#16a34a" stroke-width="2" stroke-dasharray="5 4"/>
        <text x="320" y="66" text-anchor="middle" font-weight="bold" font-size="15" fill="#15803d">Conjunto C</text>
      `;
